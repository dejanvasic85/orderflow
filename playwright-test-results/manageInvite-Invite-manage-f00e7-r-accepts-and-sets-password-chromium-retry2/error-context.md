...
Locator: getByText('Invite sent to llewellyn_medhurst@bwow.com.au')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Invite sent to llewellyn_medhurst@bwow.com.au')
...
- dialog "Invite user":
    ...
    - group:
        - text: First name
        - textbox "First name": Llewellyn
    - group:
        - text: Last name
        - textbox "Last name": Medhurst
    - group:
        - text: Email
        - textbox "Email": llewellyn_medhurst@bwow.com.au
    - group:
        - text: Mobile number
