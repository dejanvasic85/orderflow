...
Locator: getByText('Invite sent to camron_howell2@bwow.com.au')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Invite sent to camron_howell2@bwow.com.au')
...
- dialog "Invite user":
    ...
    - group:
        - text: First name
        - textbox "First name": Camron
    - group:
        - text: Last name
        - textbox "Last name": Howell
    - group:
        - text: Email
        - textbox "Email": camron_howell2@bwow.com.au
    - group:
        - text: Mobile number
